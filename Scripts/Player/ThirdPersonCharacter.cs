...
public class ThirdPersonCharacter : MonoBehaviour
{
   ...
   //     m_Animator.SetBool("Crouch", m_Crouching);
        ...
        if ( gc.sceneFP == false)
        {
                ...
                Vector3 v = (transform.position * m_MoveSpeedMultiplier) / Time.deltaTime;
                transform.position += transform.forward * m_MoveSpeedMultiplier * 3 * m_ForwardAmount * Time.deltaTime;
